...
type LoopOutRequest struct {
	...
	//
	//A flag indicating whether the defined destination address belongs to the
	//wallet. This is used to flag whether this loop out swap could have its
	//associated sweep batched.
	IsWalletAddr bool `protobuf:"varint,17,opt,name=is_wallet_addr,json=isWalletAddr,proto3" json:"is_wallet_addr,omitempty"`
}
...
func (x *LoopOutRequest) GetIsWalletAddr() bool {
	if x != nil {
		return x.IsWalletAddr
	}
	return false
}
...
var file_client_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x05, 0x0a, 0x0e, 0x4c, 0x6f, 0x6f, 0x70, 0x4f, 0x75, 0x74, 0x52,
	...
	0x24, 0x0a, 0x0e, 0x69, 0x73, 0x5f, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73, 0x57, 0x61, 0x6c, 0x6c, 0x65,
	0x74, 0x41, 0x64, 0x64, 0x72, 0x22, 0xd4, 0x02, 0x0a, 0x0d, 0x4c, 0x6f, 0x6f, 0x70, 0x49, 0x6e,
	...
	0x71, 0x75, 0x61, 0x6c, 0x69, 0x66, 0x69, 0x65, 0x64, 0x2a, 0x3b, 0x0a, 0x0b, 0x41, 0x64, 0x64,
	...
	0x53, 0x55, 0x46, 0x46, 0x49, 0x43, 0x49, 0x45, 0x4e, 0x54, 0x10, 0x0d, 0x32, 0x80, 0x08, 0x0a,
	...
	0x73, 0x74, 0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
